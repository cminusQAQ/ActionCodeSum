...
class SummarizationGenerator(object):
    ...
    def __init__(self, args, src_dict, tgt_dict, state_dict=None):
        ...
        if args.model_type == 'rnn':
            ...
            self.network = Transformer(self.args, tgt_dict).cuda()
        else:
    ...
    def init_optimizer(self, state_dict=None, use_gpu=True):
        ...
        #                     state[k] = v.cuda()
        self.optimizer = optim.Adam(self.network.parameters(), lr=self.args.learning_rate)
    ...
    def update(self, ex):
        ...
        self.updates += 1
        return loss, None, None, 0, None, None
    ...
    def load(filename, new_args=None):
        ...
        return SummarizationGenerator(args, src_dict, tgt_dict, state_dict)
